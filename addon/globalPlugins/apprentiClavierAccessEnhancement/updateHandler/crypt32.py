# globalPlugins\NVDAExtensionGlobalPlugin\updateHandler\crypt32.py
# a part of NVDAExtensionGlobalPlugin add-on
# Copyright (C) 2026 Paulber19
# This file is covered by the GNU General Public License.
# See the file COPYING for more details.
# this file is the copy of nvda crypt32.py file.
# necessary to keep the addon compatible with NVDA versions lower than 2026.1


# A part of NonVisual Desktop Access (NVDA)
# Copyright (C) 2025 NV Access Limited
# This file may be used under the terms of the GNU General Public License,
# version 2 or later, as modified by the NVDA license.
# For full terms and any additional permissions,
# see the NVDA license file: https://github.com/nvaccess/nvda/blob/master/copying.txt
...
from winKernel import FILETIME
